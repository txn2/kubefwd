...
//	//if (err != nil) { return }
//	//log.Warnf("REL:: DELETE IS UPDATING SERVICE PORT FORWARD:::%s", service.Name)
...
//			//log.Warnf("New Status \n%v\n", string(newPodJSON))
//
//			log.Infof("REL:: Pod about to terminate %+v  Phase: %s  IP: %s", newPod.Name, newPod.Status.Phase, newPod.Status.PodIP)
//			//service, err := getServiceForPod(newPod, opts.Namespace, opts.ClientSet.CoreV1())
//			//if err != nil {
//			//	log.Errorf("REL:: SERVICE NOT FOUND:::%v", err)
//			//	return
//			//}
//			//log.Infof("REL:: UPDATING SERVICE PORT FORWARD REQUIRED:::%s", service.Name)
//			////opts.UpdateServiceHandler(service, service)
//		}
//	}
//}
...
//
//	listOptions := metav1.ListOptions{}
//	log.Infof("Get Service for Deployment: #{deployment} #{namespace} #{listOptions}\n")
